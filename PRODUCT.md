...
Do not drift toward friendly consumer SaaS, oversized marketing dashboards, pastel card layouts, decorative gradients, glow effects, or raw terminal dumps. Density is welcome only when organized and traceable.

## Design Principles

1. Density with hierarchy.
2. Color is signal, never decoration.
3. Show the work behind every conclusion.
4. Motion only for genuinely live or changing state.
5. Committee-ready by default.

## Accessibility & Inclusion

Target WCAG 2.1 AA. Keep small labels legible, never encode status by color alone, honor reduced-motion preferences, and keep dense analytical controls keyboard-operable with visible focus states.
