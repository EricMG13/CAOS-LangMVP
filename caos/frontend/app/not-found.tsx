...
// `/portfolio/` keeps the trailing slash: `trailingSlash: true` means the router only
...
// in workspace authority and re-resolves it on Portfolio (Workspace.tsx `resolvedCaseId`).
export default function NotFound() {
  return <section className="panel"><div className="panel-body flow"><p className="muted">This workspace destination does not exist. Your case selection is unchanged — the top bar still holds it.</p><div><Link className="button small" href="/portfolio/">Return to Portfolio</Link></div></div></section>;
}
