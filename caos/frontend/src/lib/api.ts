...
export type WorksheetCell = { address: string; row: number; column: number; value: string | number | boolean | null; value_type: "formula" | "boolean" | "number" | "date" | "text"; formula: string | null; semantic_id: string | null; owner: string | null; write_class: string | null; period_id: string | null; source_refs: string | null; source_links?: { source_id: string; block_id: string | null }[]; number_format?: string; style?: { bold: boolean; italic: boolean; fill: string | null; align: string | null; wrap: boolean } };
