...
export default function ModelBuilder({
  ...
  return <div className="grid model-builder analyst-model-builder">
    <section className="panel span-12 model-builder-command">
      ...
      {status === "QUEUED" || status === "BUILDING" ? <StateBlock title={status === "QUEUED" ? "Build queued" : "Calculating worksheet"} body="CP-MODEL is validating canonical inputs and calculating the Application Model Build." /> : null}
