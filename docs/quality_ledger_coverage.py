...
FILE_MAP = {
    ...
    r"^caos/server/caos/observability\.py": "F-OPS-12",
    r"^caos/server/caos/config\.py": "F-CFG-01, F-CFG-02",
    r"^caos/server/caos/(contracts|responses)\.py": "F-SEC-07, F-SEC-08",
    r"^caos/server/caos/sources/": "F-SRC-01..15",
    r"^caos/server/caos/intake/": "F-SRC-15",
    ...
    r"^caos/server/caos/deliverables/": "F-DELIV-01..16",
    r"^caos/server/caos/audit/": "F-AUD-01, F-AUD-02",
    ...
    r"^caos/frontend/scripts/chart-stack-smoke\.mjs": "F-UI-05, F-UI-14, F-UI-15",
    r"^caos/frontend/scripts/run-graph-live-smoke\.mjs": "F-UI-04, F-RUN-05",
    r"^caos/frontend/scripts/run-graph-smoke\.mjs": "F-UI-04, F-RUN-04, F-RUN-05",
    r"^caos/frontend/scripts/task10-graph-matrix\.mjs": "F-UI-04, F-RUN-02",
    r"^caos/frontend/scripts/task10-incremental-qualification\.mjs": "F-SRC-15, F-RUN-01, F-MODEL-01, F-DELIV-10",
    r"^caos/frontend/scripts/task10-qualification\.mjs": "F-UI-01..15",
