...
1. The first accessibility run, taken while the backend suite was
   saturating the machine, scanned `/command-center/` (since FE-G2 `/credit/`;
   the old slug forwards) in its loading state
