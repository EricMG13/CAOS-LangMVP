...
| Release evidence package (ER-G10, 2026-09-04) | `package/PACKAGE_MANIFEST.json`, `package/PACKAGE.sha256`, `package/checks.csv`, `package/loops/`, `package/ledgers/`, `package/corpus/`, `package/inventory/`, `package/assemble_package.py`, `package/verify_evidence_package.py`, `package/golden_journeys.py` | 340 checks mapped (222 PASS, 29 PROVED HOST CONTROL, 17 BLOCKED EXTERNAL, 71 OPEN, 1 FAIL); every object hashed and re-verified on a separate copy; `signable: false` — see `.superpowers/sdd/enterprise-task-13b-report.md` |
