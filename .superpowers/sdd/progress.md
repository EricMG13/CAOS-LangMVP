...
| 2. Remove external filing acquisition dependencies | implemented; awaiting review | Codex implementer | pending | Prohibition green; bundle identity regenerated; 25 acceptance tests pass; 26 modules report zero drift; Ruff and ledger clean |
